"""
Task 1: Social Support Detection (Binary)
Model: distilbert-base-uncased fine-tuned
Classifies: Supportive (1) vs Non-Supportive (0)
Usage: python src/train_task1.py --csv Train_Data_SSD26/train-english.csv --text_col text --label_col task1
"""
...
def main(args):
    ...
    label_map  = {"Supportive": 1, "Non-Supportive": 0}
    ...
    print(classification_report(
        ...
        target_names=["Non-Supportive", "Supportive"]
    ))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task 1 - Social Support Detection (Binary)")
    parser.add_argument("--csv",       required=True,  help="Path to CSV file")
    parser.add_argument("--text_col",  default="text", help="Column name for text")
    parser.add_argument("--label_col", default="task1",help="Column name for labels")
    parser.add_argument("--max_len",   type=int, default=128)
    parser.add_argument("--batch_size",type=int, default=32)
    parser.add_argument("--epochs",    type=int, default=5)
    parser.add_argument("--lr",        type=float, default=2e-5)
    parser.add_argument("--patience",  type=int, default=2,  help="Early stopping patience")
    parser.add_argument("--save_dir",  default="./task1_model", help="Where to save best model")
