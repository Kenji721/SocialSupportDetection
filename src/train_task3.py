"""
Task 3: Community Multi-class Classification
Model: distilbert-base-uncased fine-tuned
Trains on Group-supportive comments only.
Classifies: Nation (0), Other (1), LGBTQ (2), Black Community (3), Religion (4), Women (5)
Usage: python src/train_task3.py --csv Train_Data_SSD26/train-english.csv --text_col text --label_col task3
"""
...
TARGET_NAMES = ["Nation", "Other", "LGBTQ", "Black Community", "Religion", "Women"]
...
def main(args):
    ...
    # Filter to Group-supportive comments only
    df = df[df["task2"] == "Group"][[args.text_col, args.label_col]].dropna()
    print(f"Filtered to Group comments: {len(df)} samples")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Task 3 - Community Multi-class Classification")
    parser.add_argument("--csv",       required=True,  help="Path to CSV file")
    parser.add_argument("--text_col",  default="text", help="Column name for text")
    parser.add_argument("--label_col", default="task3",help="Column name for labels")
    parser.add_argument("--max_len",   type=int, default=128)
    parser.add_argument("--batch_size",type=int, default=32)
    parser.add_argument("--epochs",    type=int, default=5)
    parser.add_argument("--lr",        type=float, default=2e-5)
    parser.add_argument("--patience",  type=int, default=3,  help="Early stopping patience")
    parser.add_argument("--save_dir",  default="./task3_model", help="Where to save best model")
